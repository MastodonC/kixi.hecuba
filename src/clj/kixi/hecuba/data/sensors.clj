...
(defn output-type-for [t operation]
  (let [op (if (string? operation)
    ...
    (case op
      ...
      :avg-for-day (str t "_avg_for_day")
      :min-for-day-morning (str t "_min_for_day_morning")
      :min-for-day-day (str t "_min_for_day_day")
      :min-for-day-evening (str t "_min_for_day_evening")
      :min-for-day-night (str t "_min_for_day_night")
      :max-for-day-morning (str t "_max_for_day_morning")
      :max-for-day-day (str t "_max_for_day_day")
      :max-for-day-evening (str t "_max_for_day_evening")
      :max-for-day-night (str t "_max_for_day_night")
      :avg-for-day-morning (str t "_avg_for_day_morning")
      :avg-for-day-day (str t "_avg_for_day_day")
      :avg-for-day-evening (str t "_avg_for_day_evening")
      :avg-for-day-night (str t "_avg_for_day_night")
      :min-rolling-4-weeks (str t "_min_rolling_4_weeks")
      :max-rolling-4-weeks (str t "_max_rolling_4_weeks")
      :avg-rolling-4-weeks (str t "_avg_rolling_4_weeks")
      :avg-rolling-4-weeks-morning (str t "_avg_rolling_4_weeks_morning")
      :avg-rolling-4-weeks-day (str t "_avg_rolling_4_weeks_day")
      :avg-rolling-4-weeks-evening (str t "_avg_rolling_4_weeks_evening")
      :avg-rolling-4-weeks-night (str t "_avg_rolling_4_weeks_night")
      :min-rolling-4-weeks-morning (str t "_min_rolling_4_weeks_morning")
      :min-rolling-4-weeks-day (str t "_min_rolling_4_weeks_day")
      :min-rolling-4-weeks-evening (str t "_min_rolling_4_weeks_evening")
      :min-rolling-4-weeks-night (str t "_min_rolling_4_weeks_night")
      ...
      :total-usage-weekly (str t "_total_usage_weekly")
      :total-usage-monthly (str t "_total_usage_monthly"))))
