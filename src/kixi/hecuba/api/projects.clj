...
(def programme-projects-resource (p/path-string :programme-projects-resource))
(def projects-index (p/path-string :projects-index))
(def project-resource (p/path-string :project-resource))
(def project-properties-index (p/path-string :project-properties-index))
